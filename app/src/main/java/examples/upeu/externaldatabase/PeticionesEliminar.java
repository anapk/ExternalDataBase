 ...
 */
public class PeticionesEliminar extends AsyncTask<String,String,String> {
    URL URLCONNECTION ;
    String urlString="http://192.168.1.35/Service/index.php?opc=4";
    Activity activity;
    JSONObject jsonArrayLista;
    public PeticionesEliminar(Activity ctx){
        activity=ctx;
    ...
    protected String doInBackground(String... params) {
        try {
            String id = params[0];
            URLCONNECTION= new URL(urlString+"&id="+id);
